...
public class ProductsController {
    ...
    public String update(@Valid @ModelAttribute("product") Products products, BindingResult result, @PathVariable("id") Integer id, Model model, HttpSession session) {
        if (result.hasErrors()) {
            model.addAttribute("product", products);
            List<Brand> brands = brand.getAllBrand();
            model.addAttribute("brand",brands);
    ...
    @PostMapping("/add")
    public String add(@Valid @ModelAttribute("product") Products products, BindingResult result, Model model, HttpSession session) {
        if (result.hasErrors()) {
